 ...
 */
angular.module('app.offer-mgmt', ['ngRoute', 'app.offer-mgmt', 'app.sales-mgmt', 'app.main', 'app.tableMgmt.templates'], 
    ...
    $routeProvider.when('/offer-mgmt/special-search', {
        ...
        resolve: {
            ...
            paginatedSpecialsList: ['offers', function (offers) {
                return offers.getPaginatedSpecials(1, 4).then(function (paginatedSpecialsList) {
                    return paginatedSpecialsList;
                });
            }]
        }
    });
